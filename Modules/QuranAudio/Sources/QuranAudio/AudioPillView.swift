                    ...
                    Button {
                        ...
                        HStack(spacing: 12) {
                            Image(systemName: option.2)
                                ...
                                .frame(width: 26)
                            Text(option.1)
                                .noorFont(size: 16, weight: player.mode == option.0 ? .semibold : .regular)
                                .foregroundStyle(NoorColor.inkPrimary)
                                .frame(maxWidth: .infinity, alignment: .leading)
