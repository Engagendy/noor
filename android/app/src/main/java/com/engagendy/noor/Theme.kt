...
private fun cairoFont(weight: FontWeight) = Font(
    resId = R.font.cairo,
    weight = weight,
...
/** Cairo variable font for Arabic interface text. Quran text keeps its dedicated fonts. */
val ArabicUiFont = FontFamily(
    cairoFont(FontWeight.Normal),
    cairoFont(FontWeight.Medium),
    cairoFont(FontWeight.SemiBold),
    cairoFont(FontWeight.Bold),
)

private val PlatformTypography = Typography()

private val ArabicTypography = PlatformTypography.copy(
    displayLarge = PlatformTypography.displayLarge.copy(fontFamily = ArabicUiFont),
    displayMedium = PlatformTypography.displayMedium.copy(fontFamily = ArabicUiFont),
    displaySmall = PlatformTypography.displaySmall.copy(fontFamily = ArabicUiFont),
    headlineLarge = PlatformTypography.headlineLarge.copy(fontFamily = ArabicUiFont),
    headlineMedium = PlatformTypography.headlineMedium.copy(fontFamily = ArabicUiFont),
    headlineSmall = PlatformTypography.headlineSmall.copy(fontFamily = ArabicUiFont),
    titleLarge = PlatformTypography.titleLarge.copy(fontFamily = ArabicUiFont),
    titleMedium = PlatformTypography.titleMedium.copy(fontFamily = ArabicUiFont),
    titleSmall = PlatformTypography.titleSmall.copy(fontFamily = ArabicUiFont),
    bodyLarge = PlatformTypography.bodyLarge.copy(fontFamily = ArabicUiFont),
    bodyMedium = PlatformTypography.bodyMedium.copy(fontFamily = ArabicUiFont),
    bodySmall = PlatformTypography.bodySmall.copy(fontFamily = ArabicUiFont),
    labelLarge = PlatformTypography.labelLarge.copy(fontFamily = ArabicUiFont),
    labelMedium = PlatformTypography.labelMedium.copy(fontFamily = ArabicUiFont),
    labelSmall = PlatformTypography.labelSmall.copy(fontFamily = ArabicUiFont),
)

@Composable
fun NoorTheme(content: @Composable () -> Unit) {
    val usesArabicUiFont = isArabicUi()
    ...
    MaterialTheme(
        colorScheme = scheme,
        typography = if (usesArabicUiFont) ArabicTypography else PlatformTypography,
    ) {
        if (usesArabicUiFont) {
            CompositionLocalProvider(
                LocalTextStyle provides LocalTextStyle.current.copy(fontFamily = ArabicUiFont),
                content = content,
            )
        } else {
            content()
